...
- Step 4 : Signup `https://www.themoviedb.org/documentation/api` and get API key <br>

  API endpoint to get data: `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}`,<br>API endpoint to search movies `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&query=` <br>API endpoint to get a movie detail `https://api.themoviedb.org/3/movie/${id}?api_key=${API_KEY}`.
...
- Here is a working [example](https://movie-app-coral-nine.vercel.app/) that you can.
